...
{plain("人话：不要再看「只讲事务消息」的侧面文。进 <a href='#ency-fm'>#ency-fm</a>，RocketMQ 金标从 CommitLog/刷盘/复制/死信/顺序一路串到金融vs电商vs物流。顶栏 <code>/</code> 全文搜索。")}
  <div class="callout danger"><div class="label">交付纪律</div>
    ...
    不合格条目不进 ENCY-FM 区。证据表：<a href='#ency-audit'>#ency-audit</a>。
  </div>
{map_mmd}
  <table>
    ...
    <tbody>
      ...
      <tr><td>RocketMQ 金标</td><td><a href="#ency-fm-rocket">#ency-fm-rocket</a></td><td>见审计</td></tr>
      ...
      <tr><td>PolarDB/Gauss/达梦/TDSQL</td><td><a href="#ency-fm-polardb">#ency-fm-polardb</a>…</td><td>见 <a href="#ency-audit">#ency-audit</a></td></tr>
